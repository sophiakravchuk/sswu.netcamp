...
//Для класів з завдання 1 перевизначити метод Equal, а також реалізувати
//порівняння для кожного з полів. Продемонструвати імплементацію
//інтерфейсів ICоmparableі ICompare.
//У класі Storage здійснити сортування масиву продуктів за заданими
//полями.
