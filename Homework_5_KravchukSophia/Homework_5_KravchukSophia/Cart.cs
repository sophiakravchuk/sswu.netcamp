...
//Змінити класи завдання 1, створивши опис додаткової сутності Корзина,
//яка є набором товарів з заданою кількістю одиниць.
//Здійснити валідацію даних.
//Врахувати, що ціна може бути введена в різних валютах з запропонованого
//переліку. Але для всіх товарів корзини повинна використовуватись єдина
//валюта.
//Вага товару теж може бути задана в різних одиницях з запропонованого
//переліку(кілограм, грам).
